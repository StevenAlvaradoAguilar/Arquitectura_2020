...
int main()
{
  ...
  //Imprimimos el mensaje de agregar el primer número.
  printf("Digite el primer numero: ");

  //Lo escaneamos y guardamos en la memoria de la computadora.
  scanf("%d", &numero_1); 

  //Imprimimos el mensaje de agregar el segundo número.
  printf("Digite el segundo numero: ");

  //Lo escaneamos y guardamos en la memoria de lacomputadora.
  scanf("%d", &numero_2); 

  //Sumamos los dos números y la guardamos en elatributo suma.
